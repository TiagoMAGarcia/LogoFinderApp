...
public class NormalWorker extends Worker{
	...
	public NormalWorker(String endereco, String PORTO, String type) throws IOException, ClassNotFoundException {
		super(endereco, PORTO, type);
		runWorker();
	}
	

	protected TaskDone procura(Task info) throws IOException, ClassNotFoundException {
